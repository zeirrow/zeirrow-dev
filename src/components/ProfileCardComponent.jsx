...
const ProfileCardComponent = ({
  ...
  const handlePointerEnter = useCallback(() => {
    ...
    wrap.classList.add(styles.cardWrapperActive);
    card.classList.add(styles.cardActive);
  }, [animationHandlers, styles]);
  ...
  const handlePointerLeave = useCallback(
    (event) => {
      ...
      wrap.classList.remove(styles.cardWrapperActive);
      ...
      <section ref={cardRef} className={styles.card}>
        <div className={styles.inside}>
          ...
          <div className={`${styles.content} ${styles.avatarContent}`}>
            <img
              className="avatar w-full h-full rounded-full object-center"
              src={avatarUrl}
